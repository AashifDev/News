...
class OtherNewsAdapter(val news: List<NewsEntity>, val fragment: Fragment):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.another_news_item,parent,false)
